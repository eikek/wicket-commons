...
import org.eknet.wicket.commons.yaml.pages.Yaml3FullheightPage;
 ...
 * example. It uses the "full height" layout.
 * <p/>
 ...
 */
public abstract class DynamicYaml3FullheightPage extends Yaml3FullheightPage {

  public DynamicYaml3FullheightPage() {
  }

  public DynamicYaml3FullheightPage(IModel<?> model) {
    super(model);
  }

  public DynamicYaml3FullheightPage(PageParameters parameters) {
    super(parameters);
  }
  ...
  public void renderHead(IHeaderResponse response) {
    ...
    YamlStyles.applyExampleDynamic3ColumnFullheightLayout(response);
  }
}
